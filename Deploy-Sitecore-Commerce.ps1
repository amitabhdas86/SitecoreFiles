#Requires -Version 3
param(
    [string]$SiteName = "sxp9u2.sc",	
	[string]$SiteHostHeaderName = "sxa.storefront.com",	
	[string]$SqlDbPrefix = "sxp9u2",
...
$params = @{
		...
		XConnectInstallDir = "$($Env:SYSTEMDRIVE)\inetpub\wwwroot\sxp9u2.xconnect"
		CertificateName = $SiteName
		CommerceServicesDbServer = "WIN-20IDVDM11DL\SQLEXPRESS"    #OR "SQLServerName\SQLInstanceName"
		CommerceServicesDbName = "SitecoreCommerce9_SharedEnvironments"
		CommerceServicesGlobalDbName = "SitecoreCommerce9_Global"		
        SitecoreDbServer = "WIN-20IDVDM11DL\SQLEXPRESS"            #OR "SQLServerName\SQLInstanceName"
		SitecoreCoreDbName = "sxp9u2_Core"
		...
		CommerceEngineCertificatePath = Resolve-Path -Path "..\assets\sxp9u2.sc.engineconnect.cer"		
		...
		BraintreeAccount = @{
			MerchantId = '2xd4xkks4vtwxvzb'
			PublicKey = '9sd2cmvdhz8vm34m'
			PrivateKey = '6209570695531efdfa1541d0ee6c93c2'
		}
